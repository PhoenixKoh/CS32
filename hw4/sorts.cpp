...
int main()
{
	...
	// destruction time.
	{
		...
		//        order.
		for (size_t k = 0; k < sensors.size(); k++)
			//sensors[k] = *(auxSensorsPtrs[k]);
			swap(sensors[k], *(auxSensorsPtrs[k]));
